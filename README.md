...
| **Day 3** | **Logistic Regression (Insurance)** | Logistic regression model predicting policy purchase chances. | [`Day 3 Course Material/Deployement Logistic Regression`]() |
